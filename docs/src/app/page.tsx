        ...
        right={
          <div className="px-5 sm:px-8 lg:px-10 py-10 lg:!pt-20 lg:pb-16">
            ...
            <p className="text-[15px] leading-7 text-foreground/70 max-w-2xl">
              ...
              email/password auth, database-backed sessions, email verification,
              password reset, and OAuth — all designed for Axum and PostgreSQL.
            </p>
...
axum::serve(listener, app).await?;`}
            ...
            <p className="text-[15px] leading-7 text-foreground/70 max-w-2xl mb-6">
              rs-auth is a Cargo workspace split into focused crates. Use only
              what you need, or pull in the facade crate for everything.
            </p>

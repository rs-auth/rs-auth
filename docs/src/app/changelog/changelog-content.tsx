  ...
  return (
    <Markdown
      ...
      components={{
        ...
        li: (props) => (
          <li
            className="text-sm text-muted-foreground leading-relaxed pl-5 relative before:content-['•'] before:absolute before:left-0 before:text-base before:leading-6 before:text-foreground/60"
            {...props}
          />
        ),
        a: ({
        ...
        >
          ...
          <div className="mt-10">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-neutral-600 dark:text-neutral-300 underline decoration-dashed underline-offset-4 hover:text-neutral-900 dark:hover:text-white transition-colors"
            >

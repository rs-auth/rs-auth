...
- **OAuth Account Lifecycle**: Linking, unlinking, and listing provider accounts
- **Auth Events & Hooks**: Event system for observing authentication operations
...
rs-auth is in active development. The core authentication flows are stable and production-ready, including stable Google and GitHub OAuth login/callback support.
